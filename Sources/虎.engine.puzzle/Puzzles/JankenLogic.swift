...
class JankenLogic: PuzzleLogic {
	...
	class func newScene(gameLogic: GameLogic) -> JankenLogic {
		guard let scene = gameLogic.loadScene(scene: "Default.Janken", resourceBundle: "虎.engine.puzzle", classType: JankenLogic.classForKeyedUnarchiver()) as? JankenLogic else {
